" Name:         Classic Vim
" Author:       Edgar Salazar <edgarmls@proton.me>
" URL:          https://www.github.com/Edgarmls1/classic-vim
...
if &background == 'dark'
  ...
  hi Normal guifg=#C8C8C8 guibg=#000000 guisp=NONE gui=NONE ctermfg=251 ctermbg=16 cterm=NONE term=NONE
  hi Boolean guifg=#FF9E64 guibg=NONE guisp=NONE gui=bold ctermfg=221 ctermbg=NONE cterm=bold term=NONE
  hi Character guifg=#6BCB77 guibg=NONE guisp=NONE gui=NONE ctermfg=78 ctermbg=NONE cterm=NONE term=NONE
  hi ColorColumn guifg=NONE guibg=#000000 guisp=NONE gui=NONE ctermfg=NONE ctermbg=16 cterm=NONE term=reverse
  hi Comment guifg=#6A7A90 guibg=NONE guisp=NONE gui=NONE ctermfg=66 ctermbg=NONE cterm=NONE term=bold
  hi Conceal guifg=#504945 guibg=NONE guisp=NONE gui=NONE ctermfg=239 ctermbg=NONE cterm=NONE term=NONE
  hi Conditional guifg=#C678DD guibg=NONE guisp=NONE gui=bold ctermfg=176 ctermbg=NONE cterm=bold term=NONE
  hi Constant guifg=#FFD866 guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE term=NONE
  hi Cursor guifg=#000000 guibg=#D0D0D0 guisp=NONE gui=NONE ctermfg=16 ctermbg=252 cterm=NONE term=reverse
  hi CursorIM guifg=#000000 guibg=#D0D0D0 guisp=NONE gui=NONE ctermfg=16 ctermbg=252 cterm=NONE term=NONE
  hi CursorLine guifg=NONE guibg=#1C1C1C guisp=NONE gui=NONE ctermfg=NONE ctermbg=234 cterm=NONE term=underline
  hi CursorLineNr guifg=#909090 guibg=#000000 guisp=NONE gui=bold ctermfg=246 ctermbg=16 cterm=bold term=bold
  hi Debug guifg=#fb5944 guibg=NONE guisp=NONE gui=NONE ctermfg=203 ctermbg=NONE cterm=NONE term=NONE
  hi Define guifg=#8888FF guibg=NONE guisp=NONE gui=NONE ctermfg=105 ctermbg=NONE cterm=NONE term=NONE
  hi Delimiter guifg=#56C2C2 guibg=NONE guisp=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE term=NONE
  hi DiffAdd guifg=NONE guibg=#1A2A1A guisp=NONE gui=NONE ctermfg=NONE ctermbg=22 cterm=NONE term=reverse
  hi DiffChange guifg=NONE guibg=#1A1A2A guisp=NONE gui=NONE ctermfg=NONE ctermbg=17 cterm=NONE term=NONE
  hi DiffDelete guifg=#FF5C5C guibg=#2A1A1A guisp=NONE gui=NONE ctermfg=203 ctermbg=52 cterm=NONE term=reverse
  hi DiffText guifg=NONE guibg=#1E2E1E guisp=NONE gui=NONE ctermfg=NONE ctermbg=23 cterm=NONE term=reverse
  ...
  hi Error guifg=#FF5C5C guibg=NONE guisp=NONE gui=bold ctermfg=203 ctermbg=NONE cterm=bold term=bold
  hi ErrorMsg guifg=#FF5C5C guibg=NONE guisp=NONE gui=NONE ctermfg=203 ctermbg=NONE cterm=NONE term=NONE
  hi Exception guifg=#FF5C5C guibg=NONE guisp=NONE gui=bold ctermfg=203 ctermbg=NONE cterm=bold term=NONE
  hi Float guifg=#FFB86C guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE term=NONE
  hi FoldColumn guifg=#505050 guibg=#000000 guisp=NONE gui=NONE ctermfg=239 ctermbg=16 cterm=NONE term=NONE
  hi Folded guifg=#505050 guibg=#141414 guisp=NONE gui=NONE ctermfg=239 ctermbg=233 cterm=NONE term=NONE
  hi Function guifg=#61AFEF guibg=NONE guisp=NONE gui=bold ctermfg=75 ctermbg=NONE cterm=bold term=NONE
  hi Identifier guifg=#D0D0D0 guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE term=NONE
  hi Ignore guifg=fg guibg=NONE guisp=NONE gui=NONE ctermfg=fg ctermbg=NONE cterm=NONE term=NONE
  hi IncSearch guifg=#000000 guibg=#D0D0D0 guisp=NONE gui=bold ctermfg=16 ctermbg=252 cterm=bold term=bold,reverse,underline
  hi Include guifg=#8888FF guibg=NONE guisp=NONE gui=NONE ctermfg=105 ctermbg=NONE cterm=NONE term=NONE
  hi Keyword guifg=#C678DD guibg=NONE guisp=NONE gui=bold ctermfg=176 ctermbg=NONE cterm=bold term=NONE
  hi Label guifg=#C8C8C8 guibg=NONE guisp=NONE gui=NONE ctermfg=251 ctermbg=NONE cterm=NONE term=NONE
  hi LineNr guifg=#909090 guibg=NONE guisp=NONE gui=NONE ctermfg=246 ctermbg=NONE cterm=NONE term=NONE
  hi Macro guifg=#8888FF guibg=NONE guisp=NONE gui=NONE ctermfg=105 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi ModeMsg guifg=#EEEEEE guibg=NONE guisp=NONE gui=bold ctermfg=255 ctermbg=NONE cterm=bold term=bold
  hi MoreMsg guifg=#909090 guibg=NONE guisp=NONE gui=NONE ctermfg=246 ctermbg=NONE cterm=NONE term=NONE
  hi NonText guifg=#504945 guibg=NONE guisp=NONE gui=NONE ctermfg=239 ctermbg=NONE cterm=NONE term=NONE
  hi Number guifg=#FFB86C guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE term=NONE
  hi Operator guifg=#9A9A9A guibg=NONE guisp=NONE gui=NONE ctermfg=247 ctermbg=NONE cterm=NONE term=NONE
  hi Pmenu guifg=#C8C8C8 guibg=#141414 guisp=NONE gui=NONE ctermfg=251 ctermbg=233 cterm=NONE term=reverse
  hi PmenuBorder guifg=#a89984 guibg=#3c3836 guisp=NONE gui=NONE ctermfg=102 ctermbg=237 cterm=NONE term=NONE
  hi PmenuExtra guifg=#a89984 guibg=#3c3836 guisp=NONE gui=NONE ctermfg=102 ctermbg=237 cterm=NONE term=reverse
  hi PmenuExtraSel guifg=#a89984 guibg=#504945 guisp=NONE gui=NONE ctermfg=102 ctermbg=239 cterm=NONE term=NONE
  hi PmenuKind guifg=#fabd2f guibg=#3c3836 guisp=NONE gui=NONE ctermfg=214 ctermbg=237 cterm=NONE term=reverse
  hi PmenuKindSel guifg=#fabd2f guibg=#504945 guisp=NONE gui=NONE ctermfg=214 ctermbg=239 cterm=NONE term=NONE
  ...
  hi PmenuSbar guifg=NONE guibg=#141414 guisp=NONE gui=NONE ctermfg=NONE ctermbg=233 cterm=NONE term=reverse
  hi PmenuSel guifg=#000000 guibg=#909090 guisp=NONE gui=NONE ctermfg=16 ctermbg=246 cterm=NONE term=bold
  hi PmenuShadow guifg=#a89984 guibg=#121212 guisp=NONE gui=NONE ctermfg=102 ctermbg=233 cterm=NONE term=NONE
  hi PmenuThumb guifg=NONE guibg=#505050 guisp=NONE gui=NONE ctermfg=NONE ctermbg=239 cterm=NONE term=NONE
  hi PreCondit guifg=#8ec07c guibg=NONE guisp=NONE gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE term=NONE
  hi PreProc guifg=#8888FF guibg=NONE guisp=NONE gui=NONE ctermfg=105 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi Repeat guifg=#C678DD guibg=NONE guisp=NONE gui=bold ctermfg=176 ctermbg=NONE cterm=bold term=NONE
  hi Search guifg=#000000 guibg=#EEEEEE guisp=NONE gui=NONE ctermfg=16 ctermbg=255 cterm=reverse term=reverse
  hi SignColumn guifg=#505050 guibg=#000000 guisp=NONE gui=NONE ctermfg=239 ctermbg=16 cterm=NONE term=reverse
  hi Special guifg=#FF79C6 guibg=NONE guisp=NONE gui=NONE ctermfg=212 ctermbg=NONE cterm=NONE term=NONE
  hi SpecialChar guifg=#FF79C6 guibg=NONE guisp=NONE gui=NONE ctermfg=212 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi SpellBad guifg=#FF5C5C guibg=NONE guisp=#FF5C5C gui=undercurl ctermfg=203 ctermbg=NONE cterm=underline term=underline
  hi SpellCap guifg=#61AFEF guibg=NONE guisp=#61AFEF gui=undercurl ctermfg=75 ctermbg=NONE cterm=underline term=underline
  hi SpellLocal guifg=#56C2C2 guibg=NONE guisp=#56C2C2 gui=undercurl ctermfg=80 ctermbg=NONE cterm=underline term=underline
  hi SpellRare guifg=#FF79C6 guibg=NONE guisp=#FF79C6 gui=undercurl ctermfg=212 ctermbg=NONE cterm=underline term=underline
  hi Statement guifg=#C678DD guibg=NONE guisp=NONE gui=bold ctermfg=176 ctermbg=NONE cterm=bold term=NONE
  hi StatusLine guifg=#C8C8C8 guibg=#141414 guisp=NONE gui=NONE ctermfg=251 ctermbg=233 cterm=NONE term=NONE
  hi StatusLineNC guifg=#505050 guibg=#141414 guisp=NONE gui=NONE ctermfg=239 ctermbg=233 cterm=NONE term=bold,underline
  hi StorageClass guifg=#56C2C2 guibg=NONE guisp=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE term=NONE
  hi String guifg=#6BCB77 guibg=NONE guisp=NONE gui=NONE ctermfg=78 ctermbg=NONE cterm=NONE term=NONE
  hi Structure guifg=#56C2C2 guibg=NONE guisp=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE term=NONE
  hi TabLine guifg=#505050 guibg=#141414 guisp=NONE gui=NONE ctermfg=239 ctermbg=233 cterm=NONE term=bold,underline
  hi TabLineFill guifg=NONE guibg=#141414 guisp=NONE gui=NONE ctermfg=NONE ctermbg=233 cterm=NONE term=NONE
  hi TabLineSel guifg=#C8C8C8 guibg=#000000 guisp=NONE gui=bold ctermfg=251 ctermbg=16 cterm=bold term=bold,reverse
  ...
  hi Todo guifg=#000000 guibg=#FFC163 guisp=NONE gui=bold ctermfg=16 ctermbg=221 cterm=bold term=bold,reverse
  ...
  hi Type guifg=#56C2C2 guibg=NONE guisp=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE term=NONE
  hi Typedef guifg=#56C2C2 guibg=NONE guisp=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE term=NONE
  hi Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline term=underline
  hi VertSplit guifg=#3C3C3C guibg=NONE guisp=NONE gui=NONE ctermfg=237 ctermbg=NONE cterm=NONE term=NONE
  hi VertSplitNC guifg=#303030 guibg=#1c1c1c guisp=NONE gui=NONE ctermfg=236 ctermbg=234 cterm=NONE term=NONE
  hi Visual guifg=NONE guibg=#3C3C3C guisp=NONE gui=NONE ctermfg=NONE ctermbg=237 cterm=NONE term=reverse
  hi WarningMsg guifg=#FFC163 guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE term=NONE
  ...
  if s:t_Co >= 16
    ...
    hi PmenuKind ctermfg=Yellow ctermbg=White cterm=NONE
    hi PmenuKindSel ctermfg=Yellow ctermbg=Black cterm=NONE
...
if &background == 'light'
  ...
  hi PmenuExtra guifg=#7c6f64 guibg=#e5d4b1 guisp=NONE gui=NONE ctermfg=243 ctermbg=187 cterm=NONE term=reverse
  hi PmenuExtraSel guifg=#3c3836 guibg=#bdae93 guisp=NONE gui=NONE ctermfg=237 ctermbg=144 cterm=NONE term=NONE
  hi PmenuKind guifg=#b57614 guibg=#e5d4b1 guisp=NONE gui=NONE ctermfg=172 ctermbg=187 cterm=NONE term=reverse
  hi PmenuKindSel guifg=#b57614 guibg=#bdae93 guisp=NONE gui=NONE ctermfg=172 ctermbg=144 cterm=NONE term=NONE
  ...
  if s:t_Co >= 16
    ...
    hi PmenuKind ctermfg=Yellow ctermbg=Grey cterm=NONE
    hi PmenuKindSel ctermfg=Yellow ctermbg=NONE cterm=NONE
